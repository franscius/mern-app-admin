...
const Sidebar = () => {
  ...
  const handleclick=()=>{
    navigate("https://gold-elegant-bison.cyclic.cloud/api/users/test")
  }
  const handleClicK=()=>{
    navigate("https://gold-elegant-bison.cyclic.cloud/api/")
  }
  const handleClick = (e) => {
    e.preventDefault();
    dispatch({
    ...
    navigate("https://gold-elegant-bison.cyclic.cloud/api/login");
  };
